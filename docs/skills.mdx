...
Install the Webcmd npm package first. Then open **Plugins**, choose **Add plugin
marketplace**, enter `agentrhq/webcmd`, and install **Webcmd**. The plugin
bundles these same seven skills; start a new task after installation.
