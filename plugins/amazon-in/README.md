# webcmd-plugin-amazon-in

Webcmd commands for amazon-in.
...
| `webcmd amazon-in whoami` | Show the current logged-in amazon-in account |
| `webcmd amazon-in wishlist` | Fetch current prices for products in the default Amazon.in wishlist |
