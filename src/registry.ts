...
declare global { var __webcmd_registry__: Map<string, CliCommand> | undefined; }
const _registry: Map<string, CliCommand> =
  globalThis.__webcmd_registry__ ??= new Map<string, CliCommand>();
 ...
 *
 * `strategy` itself is preserved as metadata for `webcmd list`, cascade
