...
describe('QuickJSHost', () => {
  ...
  it('enforces a configured memory ceiling', async () => {
    ...
    )).rejects.toThrow(/memory|allocation|interrupted/i);
  });
